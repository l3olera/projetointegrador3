...
public class GateController : MonoBehaviour
{
    ...
    [SerializeField] private GameObject _triggerSpeech; // Referência ao objeto do trigger da fala
    ...
    public void OpenGate()
    {
        if (!_isOpen) // Verifica se o portão não está aberto
        {
            ...
            _triggerSpeech.SetActive(true); // Ativa o objeto do trigger da fala
