...
public class LeverPuzzle : MonoBehaviour
{
    ...
    public static event Action<int> OnPuzzleSolved;
    ...
    void GenerateRandomCode()
    {
        ...
        for (int i = 0; i < availableColors.Count; i++)
        {
            ...
            int randomIndex = UnityEngine.Random.Range(i, availableColors.Count);
    ...
    void Check()
    {
        ...
        if (correct)
        {
            ...
            PuzzleComplete(); // Notifica que o puzzle foi resolvido
        }
    }
